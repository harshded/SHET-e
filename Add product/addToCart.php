...
if (isset($product)) {
	...
	if ($cart_id) {
		...
		if ($checkResult->num_rows > 0) {
			...
			$_SESSION['status'] = "Successfully Added to Cart";

		}
		else{
		// $cart_id = $conn->insert_id;
		$cartItemSql = "INSERT INTO cart_item (cart_id, product_id, qty, sp_price,total) VALUES ('$cart_id', '$productId',1, '$productPrice','$productPrice')";
