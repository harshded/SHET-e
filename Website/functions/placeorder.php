...
if (isset($_POST['placeorderbtn'])) {
    ...
    $stmt->bind_param("isssississsisssssissis", $user_id, $createdDate, $name, $email, $mobile, $paymentmode, $payment_id, $grand_total, $status, $city, $town_id, $pincode, $line_1, $line_2, $email, $city, $town_id, $pincode, $line_1, $line_2, $mobile, $email);
    ...
    if ($stmt->execute()) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $productqty = $row['qty'];
            $price = $row['sp_price'];
//fetching user id according to product is
